...
angular.module('angular-openweathermap', [
    ...
    return {
        restrict: 'EA',
//        <span ng-bind-html="cityName"></span> <br>
        template: '<span ng-bind-html="temperature"></span><br><i class="wi" ng-class="weatherClass" tooltip="{{weatherDescription}}" style="padding-right:5px;"></i> {{weatherDescription}}',
        transclude: true,
        scope: {
            cityName: '@',
            offsetHours: '@',
